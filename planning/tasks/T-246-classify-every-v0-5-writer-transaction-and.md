...
- A1. One implementation-derived matrix contains every command writer, storage
  mode, lock capability, consumed/published set, durability class, and recovery owner.
...
- A2: mutation tests add an unregistered sink and wrong durability annotation and
  observe deterministic failure.
