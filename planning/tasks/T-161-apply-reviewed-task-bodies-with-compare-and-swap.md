...
- Frontmatter, H1, identity, lifecycle fields, and Implementation Notes remain
  byte-equivalent; conflict, validation failure, interruption, or non-todo prompt
...
- Map criteria to digest/status races, forbidden changes, duplicate headings,
  rollback, successful byte preservation, and golden normal/follow-up/v1/v2 task
  fixtures.
