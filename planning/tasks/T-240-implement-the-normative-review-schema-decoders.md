...
- A1. Decoders enforce exact fields, enums, nullability, canonical times/paths,
  unique IDs/references, and the 1 MiB per-file cap without normalizing bytes.
...
- A1: positive goldens plus unknown/missing/duplicate/null/oversize mutation cases
  provide strict boundary evidence.
