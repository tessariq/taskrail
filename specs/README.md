...
- `v0.5.0` adds autonomous workflow integrity and reviewable planning: lifecycle-complete skills and prompts, a bounded provider-independent loop, optional unattended policy, post-spec review lenses, and adversarial task decomposition.
